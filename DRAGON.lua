...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 SADMOON.")  
...
{
{text = '𝐒𝐀𝐃𝐌𝐎𝐎𝐍 𝐂𝐇𝐀𝐍𝐍𝐄𝐋', url="t.me/UU_Le1"},
},
}
local msg_id = msg.id_/2097152/0.5
